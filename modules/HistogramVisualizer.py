...
class HistogramVisualizer(ModelVisualizer):
    ...
    def render_plot(self):
        self.js = render_template('dynamic_js/histogram.js', conf_obj=self.config_obj, data_id = self.data_id,
                        headers=self.headers, modelData=self.modelData)
        self.plot = render_template('ModelVisualizer/histogram.html', js = self.js,
