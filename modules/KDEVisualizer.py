...
class KDEVisualizer(ModelVisualizer):
    ...
    def render_plot(self):
        self.js = render_template('dynamic_js/kde.js', conf_obj=self.config_obj, data_id = self.data_id,
                        headers=self.headers, modelData=self.modelData)
        self.plot = render_template('ModelVisualizer/kde.html', js = self.js,
