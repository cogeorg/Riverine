...
class CandlestickVisualizer(ModelVisualizer):
    ...
    def read_model_data(self):
        ...
        try:
            ...
            return False
        #get the column headings from xml config file
    ...
    def render_plot(self):
        self.js = render_template('dynamic_js/candlestick.js',
            conf_obj=self.config_obj, data_id=self.data_id,
            headers=self.headers, modelData=self.modelData)
        self.plot = render_template('ModelVisualizer/candlestick.html',
