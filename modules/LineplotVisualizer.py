...
class LineplotVisualizer(ModelVisualizer):
    ...
    def render_plot(self):
        self.js = render_template('dynamic_js/lineplot.js', conf_obj=self.config_obj,
                                  modelData = self.modelData)
        self.plot = render_template('ModelVisualizer/lineplot.html', js = self.js,
