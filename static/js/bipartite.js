!function(){
	...
	var c1=[-330, 40], c2=[-50, 380], c3=[-10, 440]; //Column positions of labels.
	var colors =["#FF0000", "#BF3030", "#A60000", "#FF7400", "#BF7130", "#A64B00", "#009999", "#1D7373", "#006363", "#00CC00", "#269926"];
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Value").attr("x", (c2[d]-10))
				.attr("y", -5).style("fill","grey");
