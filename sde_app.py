...
def upload():
    if request.method == 'POST':
        ...
        #get the name of the uploaded model file        
        if filename != '':
            try:           
...
def load_user(id):
  return User.query.get(int(id)) #note that IDs in Flask-Login are unicode strings, need to typecast them to ints for sqlquery
